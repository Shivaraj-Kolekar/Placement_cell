...
EMAIL_HOST_USER = 'aniketsonkamble07@gmail.com'  # Replace with your SMTP username (if required)
EMAIL_HOST_PASSWORD = 'pkjllfvwnstdfked'  # Replace with your SMTP password (if required)
